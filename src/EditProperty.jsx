...
function EditProperty() {
  ...
  const renderDropdown = (field) => {
    if (nonDropdownFields.includes(field)) {
      return (
        <input
          type="text"
          name={field}
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="addForm w-100">
          ...
          <div>
            ...
            {priceInWords && (
              <p
                style={{ fontSize: "14px", color: "#2F747F", marginTop: "5px" }}
              >
                {priceInWords}
              </p>
            )}
    ...
    `}
          ...
          <div>
            ...
            <div className="form-group">
              <label style={{ width: "100%" }}>
                <label>
                  PostedBy <span style={{ color: "red" }}>* </span>{" "}
                </label>
          ...
          <div>
            ...
            <p className="mt-1" style={{ color: "#0597FF", fontSize: "13px" }}>
              IF YOU CAN'T FIND THE ADDRESS PLEASE ENTER MANUALLY
            </p>
          ...
          >
            ...
            >
              ...
              <Button
                ...
                style={{ backgroundColor: "rgb(47,116,127)", border: "none" }}
              >
                Close
              </Button>
            </div>
