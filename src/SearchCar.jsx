/* this file name is SearchCar
i want implement search and filter functionality for car in this file
*/
  ...
  const filteredProperties = properties.filter((property) => {
    const advancedFilterMatch = Object.keys(advancedFilters).every((key) => {
      ...
      return property[key]
        ?.toString()
        ?.toLowerCase()
        ?.includes(advancedFilters[key]?.toLowerCase());
    });
                      ...
                      <div style={{ flex: "1", position: "relative" }}>
                        ...
                        {showStatusOptions && (
                          ...
                          >
                            ...
                            {filterOptions(statusOptions).map(
                              (value, index) => (
                                <div
                                  key={index}
                    ...
                    <div style={{ display: "flex", alignItems: "center" }}>
                      <div style={{ flex: "1" }}>
                        ...
                        >
                          ...
                          {advancedFilters.propertyApproved ||
                            "Select propertyApproved"}
                        </button>
                    ...
                    <div style={{ display: "flex", alignItems: "center" }}>
                      <div style={{ flex: "1" }}>
                        ...
                        >
                          ...
                          {advancedFilters.numberOfFloors ||
                    ...
                    <div style={{ display: "flex", alignItems: "center" }}>
                      <div style={{ flex: "1" }}>
                        ...
                        >
                          ...
                          {advancedFilters.bestTimeToCall ||
                            "Select bestTimeToCall"}
                        </button>
